var chuks_project_signup = angular.module('access',["ngRoute","ngCookies","ngMessages", "ngClipboard","ngSanitize","summernote"]);

// Routing starts
chuks_project_signup.config(function($routeProvider,$locationProvider){
 $routeProvider
 .when('/',{
...
chuks_project_signup.service('storage',function($cookies,$window,$http,$location){
...
chuks_project_signup.service('notify', function ($http) {
...
chuks_project_signup.service('history', function ($http) {
...
chuks_project_signup.service('strip_text', function () {
...
chuks_project_signup.service('listLGA', function () {
  this.list = function () {
    var lgaList = {
      Abia: [
        "Aba North",
...
chuks_project_signup.service('cncf_nations', function () {
...
chuks_project_signup.service('cncf_states', function () {
...
chuks_project_signup.service('cncf_states_id', function () {
  this.states_id = function () {
    var states_id_list = {
        "Abia" : "NG-AB",
        "Adamawa" : "NG-AD",
        "Akwa Ibom" : "NG-AK",
...
chuks_project_signup.service('cncf_areas', function () {
  this.areas = function () {
    var areas_list = {
      Rivers: [
...
chuks_project_signup.service('cncf_zones', function () {
  this.zones = function () {
    var zones_list = {
      "Port Harcourt Area 1": [
        "Town Zone",
...
chuks_project_signup.service('cncf_bethels', function () {
...
chuks_project_signup.service('cncf_choirs', function () {
...
chuks_project_signup.run(function($rootScope,$anchorScroll){
    $rootScope.$on("$locationChangeSuccess", function(){
        $anchorScroll();
    })
});

chuks_project_signup.directive('fileModel', ['$parse', function ($parse) {
  //for file upload
    return {
    restrict: 'A',
...
chuks_project_signup.filter('fil_date', function () {
...
chuks_project_signup.filter('fil_time', function () {
...
chuks_project_signup.filter('fil_fmt_time', function () {
  return function (time) {
    let raw_time = time;
    let split_raw = raw_time != undefined ? raw_time.split(":") : null;
    let splitted_raw = split_raw != undefined ? split_raw[0] : null;
...
chuks_project_signup.filter('fil_id', function () {
...
chuks_project_signup.filter('bytes', function () {
...
chuks_project_signup.filter('downloads', function () {
