chuks_project.controller('add-checkerCtrl',function($scope,$rootScope,$http,$timeout,$location,$route,$window,storage,notify){
        ...
        $http.post('server/add_checker.php', $scope.checkerData)
          .then(function (response) {
            if (response.data.engineMessage == 1) {
              ...
              $scope.showSuccessStatus = "Data Checker Added !";

              notify.do_notify($scope.result_u, "Add Activity", "Data Checker added");
