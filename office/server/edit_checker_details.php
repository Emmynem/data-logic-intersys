   ...
   if ($connected) {
     ...
     try {
       ...
       if ($query2->rowCount() > 0) {
         ...
         $sql = "UPDATE checkers SET edit_user_uuid=:edit_user_uuid, fullname=:fullname, gender=:gender, phone_number=:phone_number, access=:access, last_modified=:last_modified WHERE user_uuid=:user_uuid";
