  ...
  if ($connected) {
    ...
    try {
      ...
      $sql = "SELECT people.uuid, category.category, category.stripped, people.serial_number, people.code, people.firstname, people.middlename, people.lastname, people.email, people.phone_number, people.gender,
       ...
       INNER JOIN categories category ON people.category = category.uuid WHERE people.status=:status AND people.added_date >:startdate AND (people.added_date <:enddate OR people.added_date=:enddate)
