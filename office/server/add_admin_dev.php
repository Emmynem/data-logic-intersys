  ...
  if ($connected) {
    ...
    try {
      ...
      function uuid_gen_2() {
        ...
        $GLOBALS['hybrid_uuid_2'] = strtoupper("U".$omega[1]);
      }

      uuid_gen_2();

      // $password = $data['password'];
      // $password = "wei23KS392lskd2";

      // $user_id = "Manual-DEV";
      // $data['user_role'] = 1;
      // $data['username'] = "Deamon";
      // $data['email'] = "noneofyourbusiness@myass.com";
      // $data['fullname'] = "Your Administrator";
      // $data['gender'] = "Male";
      // $data['phone_number'] = "0X0XXXXXXXX";
      ...
      $sql = "INSERT INTO users (user_uuid, edit_user_uuid, user_role, username, email, fullname, gender, phone_number, password, added_date, last_modified, access, status)
      ...
      $query->bindParam(':user_uuid', $user_id);
      // $query->bindParam(':edit_user_uuid', $data['edit_user_uuid']);
      $query->bindParam(':edit_user_uuid', $user_id);
