  ...
  if ($connected) {
    ...
    try {
      ...
      $sql = "SELECT people.uuid, category.category, category.stripped, people.serial_number, people.code, people.firstname, people.middlename, people.lastname, people.email, people.phone_number, people.gender,
       ...
       INNER JOIN categories category ON people.category = category.uuid WHERE people.category=:category AND people.part=:part AND people.choir=:choir AND people.zone=:zone AND people.area=:area AND people.state=:state AND people.nation=:nation AND people.status=:status
