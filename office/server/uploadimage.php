    ...
    try {
       ...
       if ($connected) {
         ...
         if(!empty($_FILES['file']['name'])){
           ...
           $path = '../images/bgimages/' . $newFilename;
           $path_to_delete = 'office/images/bgimages/' . $newFilename;
          ...
          if(($fileType == 'image/jpeg')  || ($fileType == 'image/jpg') || ($fileType == 'image/png')){
              ...
              if($fileSize < 30000000){
                ...
                if($fileError <= 0){
                  ...
                  if(file_exists($path)){
                    ...
                    $fileURL = $path;
                    $image_webp_url = "../images/bgimages/" . $image_webp_name;
                     ...
                     if((isset($newFilename)) && ($newFilename != "Image already exist")){
                      ...
                      if(compressImage($sourcePath, $path, 60) == 1){
                        ...
                        $output = '../images/bgimages/' .$the_time . '.webp';
                        $image_webp_url = 'office/images/bgimages/'.$the_time . ".webp";
                        ...
                        imagedestroy($content);
                         ...
                         $dir = $_SERVER['DOCUMENT_ROOT']."/royal";
             ...
             if ($file_ext == "webp" || $file_ext =="WEBP") {
               ...
               if(move_uploaded_file($_FILES['file']['tmp_name'], $path)){
                 $image_ext_url = "office/images/bgimages/" .$the_time.".".$file_ext;
