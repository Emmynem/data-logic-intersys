    ...
    try {
       ...
       if ($connected) {
         ...
         if(!empty($_FILES['file']['name'])){
           ...
           $path = '../signup_images/' . $newFilename;
           $path_to_delete = 'signup_images/' . $newFilename;
          ...
          if(($fileType == 'image/jpeg')  || ($fileType == 'image/jpg') || ($fileType == 'image/png')){
              ...
              if($fileSize < 30000000){
                ...
                if($fileError <= 0){
                  ...
                  if(file_exists($path)){
                    ...
                    $fileURL = $path;
                    $image_webp_url = "../signup_images/" . $image_webp_name;
                     ...
                     if((isset($newFilename)) && ($newFilename != "Image already exist")){
                      ...
                      if(compressImage($sourcePath, $path, 60) == 1){
                        ...
                        $output = '../signup_images/' .$the_time . '.webp';
                        $image_webp_url = 'signup_images/'.$the_time . ".webp";
             ...
             if ($file_ext == "webp" || $file_ext =="WEBP") {
               ...
               if(move_uploaded_file($_FILES['file']['tmp_name'], $path)){
                 $image_ext_url = "signup_images/" .$the_time.".".$file_ext;
